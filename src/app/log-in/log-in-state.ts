...
export class CredentialState {
  ...
  passwordError(): String {
    const err = this.passwordValidator.errors && Object.keys(this.passwordValidator.errors)[0];
    return errors[err] || '';
  }
...
export class SamePasswordCredentialState extends CredentialState {
  ...
  repeatError(): String {
    const err = this.repeatValidator.errors && Object.keys(this.repeatValidator.errors)[0];
    return errors[err] || '';
  }
  getState() {
    return {
